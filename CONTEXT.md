...
**`POST /api/auth/context/select` sincroniza `currentSchoolId` al elegir contexto `dashboard`** — branch `fix/choose-profile-dashboard-sync`, PR abierto contra `main`, **sin mergear todavía**.
