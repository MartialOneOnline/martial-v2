...
- Commits en `fix/rga-active-status`: `6bbc53a` (script + tests, dry-run) y uno posterior con el fix del rótulo de log + este resultado documentado. Rama pusheada a `origin` para revisión de Codex Project Audit — no mergeada a `main` todavía.
