...
**`/choose-profile` preserva `?redirect=` al exigir login — cierra bug P3 confirmado por auditoría en vivo** — branch `fix/choose-profile-login-preserve-redirect`, PR abierto contra `main` (partiendo de `83bd862`, el `HEAD` de la Sesión 70), pendiente de revisión/aprobación del usuario antes de merge.
