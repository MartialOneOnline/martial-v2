        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 lg:pl-4 space-y-8 text-left">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a href="/android" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-slate-900 text-white px-5 py-2.5 rounded-lg border border-slate-800 hover:bg-slate-950 transition-colors shadow-sm">
              ...
              <a href="/ios" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-slate-900 text-white px-5 py-2.5 rounded-lg border border-slate-800 hover:bg-slate-950 transition-colors shadow-sm">
