          ...
          <div className="lg:col-span-6 flex flex-col space-y-8">
            ...
            <div className="pt-6 border-t border-white/10">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <a href="https://apps.apple.com/es/app/martial/id6443845277" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-slate-900 text-white px-5 py-2.5 rounded-lg border border-slate-800 hover:bg-slate-950 transition-colors shadow-sm">
