          ...
          <div className="lg:col-span-6 flex flex-col space-y-8">
            <div className="flex flex-col gap-2.5">
              ...
              <span className="text-xs font-extrabold tracking-wider text-sky-600 uppercase mt-1">
                ★ Integrated Fight Platform for Academies
              </span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight">
              DOJO MANAGEMENT <br />
              <span className="text-[#0092ff]">MADE SIMPLE &amp; AUTOMATED</span>
            </h1>

            <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
              Empower your instructors, grow members, track certifications &amp; payments with bespoke fighter-centric software templates.
            </p>
            ...
            <div className="pt-6 border-t border-gray-100">
              <p className="text-xs font-bold tracking-widest text-slate-400 uppercase mb-4">Available on:</p>
          ...
          <div className="lg:col-span-6 relative flex flex-col items-center">
            <div className="relative w-full max-w-lg aspect-square rounded-3xl overflow-hidden bg-slate-900 border-4 border-white shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex flex-col gap-4 z-10">
                ...
                >
                  {[
                    { icon: <Calendar className="w-4 h-4" />, label: 'Bookings',  value: slide.bookings },
                    { icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>, label: 'Students', value: slide.students },
                    { icon: <Award className="w-4 h-4" />,    label: 'Classes',   value: slide.classes  },
                    { icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>, label: 'Payments', value: slide.payments },
                  ].map(s => (
