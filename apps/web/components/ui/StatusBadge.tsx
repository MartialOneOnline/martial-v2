...
export function StatusBadge({ status, variant = 'soft', size = 'sm', showDot = true }: StatusBadgeProps) {
  const key = status.toUpperCase() as MemberStatus
  const token = memberStatusColors[key] ?? memberStatusColors.ARCHIVED
