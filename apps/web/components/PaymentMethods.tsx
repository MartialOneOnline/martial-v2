...
const PAYMENTS = [
  ...
  { name: 'Direct Debit', logo: <span className="flex items-center gap-1 text-[11px] font-black tracking-wider text-slate-800 uppercase border-2 border-slate-800 p-1 rounded-sm"><Landmark className="w-3.5 h-3.5" /><span>Direct Debit</span></span> },
    ...
    <section className="bg-white py-14 sm:py-16 border-y border-gray-100">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
        <div className="max-w-2xl mx-auto mb-10">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 leading-tight uppercase">
