...
import { RefreshCw, Award, Menu } from 'lucide-react'
      ...
      <div className="bg-white border-b border-gray-100 px-4 md:px-8 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3 sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 hidden sm:block">Belt promotions across all schools — last 12 months</p>
          </div>
        </div>
        <div className="flex items-center gap-3 min-w-0">
          <div className="flex-1 min-w-0"><ReportsTabs active="/admin/reports/gradings" /></div>
          <button onClick={load}
