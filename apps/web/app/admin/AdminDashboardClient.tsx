        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 bg-white border border-gray-100 rounded-2xl shadow-sm">
            <div className="flex items-start justify-between px-6 pt-5 pb-4 border-b border-gray-50">
              ...
              <Link href="/admin/schools" className="flex items-center gap-1 text-xs font-semibold text-[#0870E2] hover:underline mt-0.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-50">
              ...
              <Link href="/admin/schools/all" className="flex items-center gap-1 text-xs font-semibold text-[#0870E2] hover:underline">
                View all <ArrowUpRight className="w-3 h-3" />
              </Link>
            </div>
                ...
                {(stats?.recentSchools.length ?? 0) === 0 && (
                  <tr>
                    <td colSpan={5} className="px-6 py-10 text-center">
                      ...
                      <Link href="/admin/schools" className="text-xs text-[#0870E2] font-semibold hover:underline mt-1 inline-block">
